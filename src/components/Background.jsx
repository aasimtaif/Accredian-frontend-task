...
const Background = ({ className = "" }) => {
  ...
  return (
    <footer
      className={`self-stretch bg-homeaccrediancom-mine-shaft flex flex-row items-end justify-between py-8 pr-[19px] pl-[360px] box-border max-w-full gap-[20px] text-left text-sm text-homeaccrediancom-nero font-homeaccrediancom-roboto-bold-17 mq900:pl-[90px] mq900:pt-[21px] mq900:pb-[21px] mq900:box-border mq450:pt-5 mq450:pb-5 mq450:box-border mq1300:pl-[180px] mq1300:box-border mq1650:flex-wrap mq1650:justify-center ${className}`}
    >
