              ...
              <div className="self-stretch flex flex-col items-end justify-start gap-[35px] max-w-full mq450:gap-[17px]">
                <div className="self-stretch flex flex-row items-start justify-start max-w-full">
                  <div className="flex-1 flex flex-col items-start justify-start pt-[57px] px-0 pb-0 box-border max-w-full mq900:pt-[37px] mq900:box-border">
                    <div className="self-stretch shadow-[0px_4px_29.3px_rgba(60,_60,_60,_0.15)] rounded-t-none rounded-b-sm bg-aliceblue-200 flex flex-row items-start justify-between pt-[31px] pb-4 pr-[66px] pl-[27px] box-border max-w-full gap-[20px] z-[1] mq900:flex-wrap mq900:pt-5 mq900:pb-5 mq900:box-border mq1300:pr-[33px] mq1300:box-border">
                      ...
                      <div className="w-[262px] flex flex-col items-start justify-start pt-3 px-0 pb-0 box-border min-w-[262px] text-center mq900:flex-1">
                        <div className="self-stretch flex flex-row items-start justify-between gap-[20px]">
                          <div className="w-[72px] flex flex-col items-start justify-start pt-px px-0 pb-0 box-border">
                            <div className="self-stretch flex flex-col items-start justify-start gap-[43px]">
                              <div className="relative leading-[24px] inline-block min-w-[62px] whitespace-nowrap z-[2] mq450:text-base mq450:leading-[19px]">
                                ₹ 7,000
                              </div>
                              <div className="relative leading-[24px] inline-block min-w-[62px] whitespace-nowrap z-[2] mq450:text-base mq450:leading-[19px]">
                                ₹ 9,000
                              </div>
                              <div className="relative leading-[24px] inline-block min-w-[72px] whitespace-nowrap z-[2] mq450:text-base mq450:leading-[19px]">
                                ₹ 10,000
                              </div>
                              <div className="relative leading-[24px] inline-block min-w-[72px] whitespace-nowrap z-[2] mq450:text-base mq450:leading-[19px]">
                                ₹ 10,000
